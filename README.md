...
- It's a .NET 10 C# GUI Program that wraps around a library called FFmpegCore which allow users to easily convert video files (or change their bitrates) without touching the terminal.
